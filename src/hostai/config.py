...
ENV_MAP: Dict[str, tuple[str, str, Optional[Type[Any]]]] = {
    ...
    "HOSTAI_VOLUME_ID": ("vast", "volume_id", str),
    "HOSTAI_VOLUME_MOUNT_PATH": ("vast", "volume_mount_path", str),
    "HOSTAI_SHM_SIZE_GB": ("vast", "shm_size_gb", int),
    ...
    "HOSTAI_SLOT_CACHE_USER": ("cache", "user", str),
    "HOSTAI_SLOT_CACHE_ROOT": ("cache", "root", str),
    "HOSTAI_SLOT_CACHE_MAX_GB": ("cache", "max_gb", int),
    "HOSTAI_SLOT_CACHE_SESSION": ("cache", "session", str),
    "HOSTAI_SLOT_CACHE_USE_SHM": ("cache", "use_shm", bool),
    "HOSTAI_SHM_MIN_GB": ("cache", "shm_min_gb", int),
    "HOSTAI_SLOT_CACHE_SHM_REQUIRE": ("cache", "shm_require", bool),
    "HOSTAI_SLOT_CACHE_KEY": ("cache", "key", str),
    "HOSTAI_SLOT_CACHE_SLOT_ID": ("cache", "slot_id", int),
    "HOSTAI_SLOT_CACHE_LOCAL_DIR": ("cache", "local_dir", str),
    "HOSTAI_SLOT_CACHE_REQUIRE_SAVE": ("cache", "require_save", bool),
    "HOSTAI_SLOT_CACHE_RCLONE": ("cache", "rclone", bool),
    "HOSTAI_SLOT_CACHE_RCLONE_REMOTE": ("cache", "rclone_remote", str),
    "HOSTAI_SLOT_CACHE_RCLONE_TYPE": ("cache", "rclone_type", str),
    "HOSTAI_SLOT_CACHE_RCLONE_URL": ("cache", "rclone_url", str),
    "HOSTAI_SLOT_CACHE_RCLONE_USER": ("cache", "rclone_user", str),
    "HOSTAI_SLOT_CACHE_RCLONE_PASSWORD": ("cache", "rclone_password", str),
    "HOSTAI_MONITOR_THRESHOLD_PCT": ("monitor", "threshold_pct", float),
    "HOSTAI_MONITOR_INTERVAL": ("monitor", "interval", int),
    "HOSTAI_MONITOR_MAX_RESULTS": ("monitor", "max_results", int),
    "HOSTAI_MONITOR_AUTO_START": ("monitor", "auto_start", bool),
    "HOSTAI_MONITOR_PROFILE": ("monitor", "profile", str),
    "HOSTAI_MONITOR_GROUP": ("monitor", "group", str),
